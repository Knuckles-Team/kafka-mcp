...
|----------|----------|-------|
| `KAFKA_REST_URL` | ✅ | Confluent REST Proxy base URL (default `[configured-endpoint]`) |
...
| `KAFKA_REST_TLS_PROFILE_REF` | optional | Runtime secret ref for private TLS trust |
