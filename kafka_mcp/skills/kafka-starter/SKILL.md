...
name: kafka-starter
description: >-
  Kafka API + MCP Server + A2A Server Use when working with Kafka via this package's MCP
...
license: MIT
tags: [kafka-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---
...
Starter skill for the **Kafka** package. Use the `mcp-client` universal skill
