"""kafka-mcp: Apache Kafka (REST Proxy / native) API + MCP Server + A2A Server."""
...
CORE_MODULES = ["kafka_mcp.api_client"]
OPTIONAL_MODULES = {
    "kafka_mcp.agent_server": "agent",
    "kafka_mcp.mcp_server": "mcp",
}
